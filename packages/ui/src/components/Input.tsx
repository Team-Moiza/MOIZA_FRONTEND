...
export const Input = forwardRef<HTMLInputElement, InputPropsType>(({ isBig, icon = false, ...rest }, ref) => {
  return (
    <div
      style={{
    ...
    >
      ...
      <input
        ...
        {...rest}
        className={`w-[100%] h-[calc(100%_+_2px)] ${isBig ? "text-p1" : "text-p5"} text-black placeholder:text-gray-400 outline-0`}
      />
    </div>
  );
});
