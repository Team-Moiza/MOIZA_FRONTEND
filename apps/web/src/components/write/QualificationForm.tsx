    ...
    return (
        <div id="certificates" className="w-[832px] h-fit px-[28px] pt-[24px] pb-[32px] flex flex-col bg-white gap-5 rounded-[12px]">
            ...
            {fields.map((field, index) => (
                <div
                    className={`w-full flex flex-col gap-4 ${index !== 0 ? "border-t-[5px] border-gray-100 pt-8 mt-4" : ""}`}
                    key={field.id}
                >
                    <InputTemplate full>
                    ...
                    <div className="w-full flex flex-col gap-8">
                        <div className="w-full flex justify-between">
                            <InputTemplate>
                                ...
                                <Input
                                    width={247}
                                    placeholder="점수 또는 급을 입력하세요"
                                    defaultValue={field.score}
                                    {...register(
                                        `qualifications.${index}.score`
                                    )}
                                />
                            </InputTemplate>
                            <InputTemplate>
            ...
            <button
                ...
                type="button"
                onClick={() => append({ date: "", score: "", name: "" })}
            >
