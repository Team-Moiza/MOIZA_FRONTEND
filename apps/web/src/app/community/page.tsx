        ...
        {dummyPost.map((post, index) => (
          ...
          >
            <div className="relative w-[100%] h-[264px]">
              ...
              <div className="absolute bottom-0 w-[100%] h-[120px] bg-gradient-to-t from-white to-transparent [background:linear-gradient(0deg,#FFF 0%,rgba(255,255,255,0.64) 51.13%,rgba(255,255,255,0.32) 75.88%,rgba(255,255,255,0) 100%)]"></div>
            </div>
